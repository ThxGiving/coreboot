...
DefinitionBlock ("", "SSDT", 2, "INTEL", "NUC5i5RY", 0x00000182)
{
    ...
    OperationRegion (SANV, SystemMemory, 0xA2C72E18, 0x0192)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        OperationRegion (PCS0, SystemMemory, (XBAS + (SBC0 << 0x14)), 0xF0)
        ...
        OperationRegion (CAP0, SystemMemory, ((XBAS + (SBC0 << 0x14)) + EECP), 0x14)
        ...
        OperationRegion (PCS1, SystemMemory, (XBAS + (SBC1 << 0x14)), 0xF0)
        ...
        OperationRegion (CAP1, SystemMemory, ((XBAS + (SBC1 << 0x14)) + EEC1), 0x14)
        ...
        OperationRegion (PCS2, SystemMemory, (XBAS + (SBC2 << 0x14)), 0xF0)
        ...
        OperationRegion (CAP2, SystemMemory, ((XBAS + (SBC2 << 0x14)) + EEC2), 0x14)
