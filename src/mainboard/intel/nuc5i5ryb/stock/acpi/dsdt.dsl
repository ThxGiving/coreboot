 ...
 */
DefinitionBlock ("", "DSDT", 2, "INTEL", "NUC5i5RY", 0x00000182)
{
    /*
    ...
    Name (TPMM, 0xFED70000)
    Name (FTPM, 0xA2FFF000)
    Name (AMDT, Zero)
    Name (TPMF, One)
    Name (RMIS, 0x00)
    Name (SS1, Zero)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xA2C7B000, 0x0363)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0xA22A1F18, 0x10)
                ...
                Device (SIO1)
                {
                    ...
                    Method (SIOS, 1, NotSerialized)
                    {
                        ...
                        If ((0x05 != Arg0))
                        {
                            ...
                            OPT2 |= One /* \_SB_.PCI0.LPCB.SIO1.OPT2 */
                            EXFG ()
                        }
                    }
                    ...
                    Method (SIOW, 1, NotSerialized)
                    {
                        ...
                        OPT3 = 0xFF
                        OPT6 &= 0xCF
                        OPT2 &= 0xFE /* \_SB_.PCI0.LPCB.SIO1.OPT2 */
                        EXFG ()
                    }
                ...
                Device (CIR)
                {
                    ...
                    Method (_SRS, 1, NotSerialized)  // _SRS: Set Resource Settings
                    {
                        ...
                        ^^SIO1.IOAL = IOLA /* \_SB_.PCI0.LPCB.CIR_._SRS.IOLA */
                        ^^SIO1.IOAH = IOHA /* \_SB_.PCI0.LPCB.CIR_._SRS.IOHA */
                        If (IRQE)
                        {
                            FindSetRightBit (IRQE, Local0)
                            ^^SIO1.INTR = (Local0 - One)
                        }
                        Else
                        {
                            ^^SIO1.INTR = Zero
                        ...
                        ^^SIO1.ACTR = One
                        Local0 = ^^SIO1.IRRX /* \_SB_.PCI0.LPCB.SIO1.IRRX */
                        Local0 &= 0xEF
                        Local0 |= 0x10
                        ^^SIO1.IRRX = Local0
                        ^^SIO1.EXFG ()
                        ...
                        ^^SIO1.IOAL = IOLB /* \_SB_.PCI0.LPCB.CIR_._SRS.IOLB */
                        ^^SIO1.IOAH = IOHB /* \_SB_.PCI0.LPCB.CIR_._SRS.IOHB */
                        ^^SIO1.ACTR = One
                        ^^SIO1.EXFG ()
                        ^^SIO1.ENFG (0x0A)
                        ^^SIO1.RGE0 |= 0x08
                    ...
                    Name (PBUF, ResourceTemplate ()
                    {
                        IO (Decode16,
                            ...
                            0x00,               // Length
                            _Y15)
                        IRQ (Edge, ActiveHigh, Shared, _Y16)
                            {0}
                        IO (Decode16,
                            0x0000,             // Range Minimum
                            0x0000,             // Range Maximum
                    ...
                    CreateWordField (PBUF, \_SB.PCI0.LPCB.CIR._Y15._MIN, IO11)  // _MIN: Minimum Base Address
                    CreateWordField (PBUF, \_SB.PCI0.LPCB.CIR._Y15._MAX, IO12)  // _MAX: Maximum Base Address
                    CreateByteField (PBUF, \_SB.PCI0.LPCB.CIR._Y15._LEN, LEN1)  // _LEN: Length
                    CreateWordField (PBUF, \_SB.PCI0.LPCB.CIR._Y16._INT, IRQE)  // _INT: Interrupts
                    CreateWordField (PBUF, \_SB.PCI0.LPCB.CIR._Y17._MIN, IO21)  // _MIN: Minimum Base Address
                    CreateWordField (PBUF, \_SB.PCI0.LPCB.CIR._Y17._MAX, IO22)  // _MAX: Maximum Base Address
                    CreateByteField (PBUF, \_SB.PCI0.LPCB.CIR._Y17._LEN, LEN2)  // _LEN: Length
                    Method (IRCR, 1, NotSerialized)
                    {
                        ^^SIO1.ENFG (Arg0)
                        IO11 = (^^SIO1.IOAH << 0x08)
                        IO11 |= ^^SIO1.IOAL /* \_SB_.PCI0.LPCB.CIR_.IO11 */
                        IO12 = IO11 /* \_SB_.PCI0.LPCB.CIR_.IO11 */
                        LEN1 = 0x10
                        If (^^SIO1.INTR)
                        {
                            IRQE = (One << ^^SIO1.INTR) /* \_SB_.PCI0.LPCB.SIO1.INTR */
                        }
                        Else
                        {
                            IRQE = Zero
                        ...
                        ^^SIO1.ENFG (0x0E)
                        IO21 = (^^SIO1.IOAH << 0x08)
                        IO21 |= ^^SIO1.IOAL /* \_SB_.PCI0.LPCB.CIR_.IO21 */
                        IO22 = IO21 /* \_SB_.PCI0.LPCB.CIR_.IO21 */
                        LEN2 = 0x10
                        ^^SIO1.EXFG ()
                        Return (PBUF) /* \_SB_.PCI0.LPCB.CIR_.PBUF */
                    }
    ...
    Scope (_SB.PCI0)
    {
        Device (PDRC)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                RBR0 = (^^LPCB.RCBA << 0x0E)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y19._BAS, SNR0)  // _BAS: Base Address
                SNR0 = SRMB /* \SRMB */
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y1A._BAS, XWT0)  // _BAS: Base Address
                XWT0 = XWMB /* \XWMB */
    ...
    Scope (_SB.PCI0)
    {
        ...
        Method (MBUF, 2, Serialized)
        {
            ...
            CreateDWordField (RBUF, \_SB.PCI0.MBUF._Y1F._BAS, ADDR)  // _BAS: Base Address
            CreateDWordField (RBUF, \_SB.PCI0.MBUF._Y1F._LEN, LENG)  // _LEN: Length
            ADDR = Arg0
            LENG = Arg1
        ...
        Method (LDMA, 2, Serialized)
        {
            ...
            {
                FixedDMA (0x0000, 0x0000, Width32bit, _Y22)
                FixedDMA (0x0000, 0x0000, Width32bit, _Y23)
            })
            CreateWordField (DBUF, One, D1DM)
            CreateWordField (DBUF, \_SB.PCI0.LDMA._Y22._TYP, D1TY)  // _TYP: Type
            CreateWordField (DBUF, \_SB.PCI0.LDMA._Y23._DMA, D2DM)  // _DMA: Direct Memory Access
            CreateWordField (DBUF, \_SB.PCI0.LDMA._Y23._TYP, D2TY)  // _TYP: Type
            D1DM = Arg0
            D2DM = (Arg0 + One)
            D1TY = Arg1
            D2TY = (Arg1 + One)
        ...
        Device (GPI0)
        {
            ...
            CreateDWordField (RBUF, \_SB.PCI0.GPI0._Y24._MIN, BMIN)  // _MIN: Minimum Base Address
            CreateDWordField (RBUF, \_SB.PCI0.GPI0._Y24._MAX, BMAX)  // _MAX: Maximum Base Address
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                BMIN = GPMN /* \GPMN */
                BMAX = GPMX /* \GPMX */
    ...
    Scope (_SB.PCI0.I2C0)
    {
        ...
        Device (ACD0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                {
                    Interrupt (ResourceConsumer, Level, ActiveHigh, ExclusiveAndWake, ,, _Y26)
                    {
                        0x00000025,
                    }
                })
                ...
                {
                    CreateByteField (IRB0, \_SB.PCI0.I2C0.ACD0._CRS._Y25._INT, VAL1)  // _INT: Interrupts
                    VAL1 = 0x1E
                    CreateByteField (IRB1, \_SB.PCI0.I2C0.ACD0._CRS._Y26._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1E
                }
        ...
        Device (ACD1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                {
                    ...
                    Interrupt (ResourceConsumer, Edge, ActiveLow, ExclusiveAndWake, ,, _Y27)
                    {
                        0x00000025,
                    }
                ...
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (RBUF, \_SB.PCI0.I2C0.ACD1._CRS._Y27._INT, VAL1)  // _INT: Interrupts
                    VAL1 = 0x1E
        ...
        Device (ACD2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                {
                    ...
                    Interrupt (ResourceConsumer, Edge, ActiveHigh, ExclusiveAndWake, ,, _Y28)
                    {
                        0x00000025,
                    }
                })
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    ...
                    VAL1 = 0x2E
                    CreateByteField (RBUF, \_SB.PCI0.I2C0.ACD2._CRS._Y28._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1E
                }
        ...
        Device (SHUB)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateDWordField (SBFI, \_SB.PCI0.I2C0.SHUB._CRS._Y29._SPE, I2CG)  // _SPE: Speed
                I2CG = SHFQ /* \SHFQ */
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
        ...
        Device (DFUD)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateDWordField (SBFI, \_SB.PCI0.I2C0.DFUD._CRS._Y2A._SPE, I2CG)  // _SPE: Speed
                I2CG = SHFQ /* \SHFQ */
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, 0x41, VAL1)
    ...
    Scope (_SB.PCI0.I2C1)
    {
        Device (TPL4)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPL4._CRS._Y2B._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1F
                }
        ...
        Device (TPL0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPL0._CRS._Y2C._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1F
                }
        ...
        Device (TPL1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (SBFI, \_SB.PCI0.I2C1.TPL1._CRS._Y2D._INT, VAL4)  // _INT: Interrupts
        ...
        Device (TPL2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (IRBU, \_SB.PCI0.I2C1.TPL2._CRS._Y2E._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1F
                }

                CreateDWordField (SBFI, \_SB.PCI0.I2C1.TPL2._CRS._Y2F._SPE, I2CG)  // _SPE: Speed
                I2CG = TL2F /* \TL2F */
                If ((BID == 0x31))
                {
        ...
        Device (TPL3)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (SBFI, \_SB.PCI0.I2C1.TPL3._CRS._Y30._INT, VAL4)  // _INT: Interrupts
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    VAL4 = 0x1F
                }
        ...
        Device (TPD0)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD0._CRS._Y31._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                }

                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD0._CRS._Y31._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1A
                }
        ...
        Device (TPD1)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD1._CRS._Y32._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                }

                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD1._CRS._Y32._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1A
                }
        ...
        Device (TPD2)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD2._CRS._Y33._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                }

                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD2._CRS._Y33._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1A
                }
        ...
        Device (TPD3)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD3._CRS._Y34._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                }

                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD3._CRS._Y34._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1A
                }
        ...
        Device (TPD7)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD7._CRS._Y35._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                    If ((S0ID == Zero))
                    {
                ...
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD7._CRS._Y35._INT, VAL7)  // _INT: Interrupts
                    VAL7 = 0x1A
                }
        ...
        Device (TPD8)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD8._CRS._Y36._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                    If ((S0ID == Zero))
                    {
                        CreateByteField (SBFI, 0x24, VAL4)
                ...
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD8._CRS._Y36._INT, VAL7)  // _INT: Interrupts
                    VAL7 = 0x1A
                }
    ...
    Scope (_SB.PCI0.SDHC)
    {
        Device (WI01)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                If ((SB07 != Zero))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SDHC.WI01._Y37._LEN, WLN0)  // _LEN: Length
                    WLN0 = 0x0C
                    CreateDWordField (RBUF, \_SB.PCI0.SDHC.WI01._Y37._BAS, WVAL)  // _BAS: Base Address
                    WVAL = (SB07 + 0x1008)
                }
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (ADSP)
        {
            ...
            CreateDWordField (RBUF, \_SB.PCI0.ADSP._Y38._BAS, B0VL)  // _BAS: Base Address
            CreateDWordField (RBUF, \_SB.PCI0.ADSP._Y39._BAS, B1VL)  // _BAS: Base Address
            CreateDWordField (RBUF, \_SB.PCI0.ADSP._Y3A._INT, IRQN)  // _INT: Interrupts
            Name (MCLK, Zero)
            Name (SCLK, Zero)
            Name (SSPM, Zero)
            Name (ABTH, Zero)
    ...
    Scope (_SB.PCI0)
    {
        Device (HECI)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (CRS, \_SB.PCI0.HECI._Y3B._BAS, DBAS)  // _BAS: Base Address
                CreateDWordField (CRS, \_SB.PCI0.HECI._Y3B._LEN, DLEN)  // _LEN: Length
                If ((DRMB != Zero))
                {
                    DBAS = DRMB /* \DRMB */
                    DLEN = 0x01000000
