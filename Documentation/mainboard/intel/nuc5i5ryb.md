...
| Intel ME firmware (kept in the ME region)              | Management Engine / PTT |

The blobs live under
`3rdparty/blobs/mainboard/intel/nuc5i5ryb/`. The ME region is preserved
from the factory image; coreboot only replaces the BIOS region.
